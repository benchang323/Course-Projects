...
int main()
{
  ...
  return 0;
    ...
    cout << "*----------------------------------------------------------------*" << endl;
    cout << "|                                                                |" << endl; 
    cout << "|                Welcome to Benjamin's Battleship                |" << endl;
    cout << "|                                                                |" << endl;   
    cout << "*----------------------------------------------------------------*" << endl;
        cout << "*-------------------------------------------------------------------------------------*" << endl;
    cout << "| TUTORIAL                                                                            |" << endl;          
    cout << "|  - S is your ship.                                                                  |" << endl;
    cout << "|  - 0 is the unknown block.                                                          |" << endl;
    cout << "|  - H is a direct hit.                                                               |" << endl;
    cout << "|  - N indicates you have missed.                                                     |" << endl;
    cout << "|                                                                                     |" << endl;
    cout << "| HOW TO PLAY?                                                                        |" << endl;
    cout << "|  - Shoot a location on the board trying to find the enemy's ship                    |" << endl;
    cout << "|  - Once all the enemy's ships have been sunk, you win.                              |" << endl;
    cout << "|  - Have fun!                                                                        |" << endl;
    cout << "|                                                                                     |" << endl;
    cout << "*-------------------------------------------------------------------------------------*" << endl; 